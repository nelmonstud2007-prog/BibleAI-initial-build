...
import { Mail, Lock, Loader2, ArrowRight, Cross, ShieldCheck, Sparkles } from 'lucide-react';
...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen bg-navy-950 flex items-center justify-center px-6 relative overflow-hidden mesh-gradient">
      ...
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-gold-400/5 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="relative bg-navy-900 border border-white/5 rounded-[2.5rem] p-8 sm:p-12 shadow-2xl space-y-10">
          ...
          <div className="text-center space-y-4">
             ...
             <div className="space-y-1">
                ...
                <p className="text-navy-400 text-sm font-medium">Continue your spiritual journey today.</p>
             </div>
          </div>
          ...
          <form onSubmit={handleSignIn} className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-[10px] font-black text-navy-500 uppercase tracking-[0.2em] ml-2">Sacred Email</label>
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between items-center px-2">
                   <label className="text-[10px] font-black text-navy-500 uppercase tracking-[0.2em]">Password</label>
                   <Link to="/forgot-password" title="Feature coming soon" className="text-[10px] font-black text-navy-600 uppercase tracking-widest hover:text-gold-400 transition-colors">Recover Access?</Link>
                </div>
                <div className="relative">
                  <input
                    type="password"
          ...
          <p className="text-center text-[10px] font-black text-navy-600 uppercase tracking-widest">
            ...
            <Link to="/signup" className="text-gold-400 hover:text-white transition-colors">Begin Your Journey</Link>
          </p>

          <div className="flex items-center justify-center gap-6 opacity-30 pt-4">
             <div className="flex items-center gap-1.5">
                <ShieldCheck className="w-3 h-3 text-white" />
                <span className="text-[8px] font-black text-white uppercase tracking-widest">Secure Access</span>
             </div>
             <div className="flex items-center gap-1.5">
                <Sparkles className="w-3 h-3 text-white" />
                <span className="text-[8px] font-black text-white uppercase tracking-widest">Spirit-Led Tech</span>
             </div>
          </div>
        </div>
      </div>
