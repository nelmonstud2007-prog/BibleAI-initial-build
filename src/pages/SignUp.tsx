...
export default function SignUp() {
  const { user, profileCompleted, signUp } = useAuth();
    ...
    return (
      <div className="min-h-screen bg-navy-950 flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <Link to="/signin" className="mt-6 inline-block text-sm text-gold-400 hover:text-gold-300 font-medium transition-colors">
            Back to sign in
          </Link>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="bg-navy-900/60 border border-navy-800 rounded-2xl p-6 sm:p-8 space-y-5 shadow-2xl shadow-black/30">
            ...
            <p className="text-center text-sm text-navy-400">
              ...
              <Link to="/signin" className="text-gold-400 hover:text-gold-300 font-medium transition-colors">Sign in</Link>
            </p>
          </form>
        </div>
      </div>
